...
/* plugin state */
 ...
 herr_t H5PLget_loading_state(unsigned int *plugin_type/*out*/);
 ...
 ssize_t H5PLget(unsigned int index, char *pathname/*out*/, size_t size);
 herr_t H5PLsize(unsigned int *listsize/*out*/);
