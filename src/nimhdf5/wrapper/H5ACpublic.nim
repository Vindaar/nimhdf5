...
const
  H5AC_CURR_CACHE_CONFIG_VERSION* = 1
  H5AC_MAX_TRACE_FILE_NAME_LEN* = 1024
  H5AC_METADATA_WRITE_STRATEGY_PROCESS_0_ONLY* = 0
  H5AC_METADATA_WRITE_STRATEGY_DISTRIBUTED* = 1

type
  H5AC_cache_config_t* = object
    version*: cint             ##  general configuration fields:
...
## 	H5AC_CACHE_IMAGE_ENTRY_AGEOUT_NONE (-1) to
## 	H5AC_CACHE_IMAGE_ENTRY_AGEOUT_MAX (100).
##
## 	H5AC_CACHE_IMAGE_ENTRY_AGEOUT_NONE means that no limit
...
## 	H5AC_CACHE_IMAGE_ENTRY_AGEOUT_MAX can be increased from its
## 	current value, any value in excess of 255 will be the functional
## 	equivalent of H5AC_CACHE_IMAGE_ENTRY_AGEOUT_NONE.
##
## **************************************************************************

const
  H5AC_CURR_CACHE_IMAGE_CONFIG_VERSION* = 1
  H5AC_CACHE_IMAGE_ENTRY_AGEOUT_NONE* = - 1
  H5AC_CACHE_IMAGE_ENTRY_AGEOUT_MAX* = 100

type
  H5AC_cache_image_config_t* = object
    version*: cint
